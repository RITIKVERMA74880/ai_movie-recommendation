...
def load_and_prepare_data():
    ...
    movies1 = pd.read_csv(
        r'C:\Users\ritik\OneDrive\Desktop\movie_ai\movies.csv'
    )
    movies2 = pd.read_csv(
        r'C:\Users\ritik\OneDrive\Desktop\movie_ai\bollywood_movies.csv'
    )
    movies3 = pd.read_csv(
        r'C:\Users\ritik\OneDrive\Desktop\movie_ai\tmdb_5000_movies.csv'
    )
